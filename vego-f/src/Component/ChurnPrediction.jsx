        ...
        <div class="card w-75 container mt-6 form-container mt-5 px-5 shadow-lg cardcol">
          ...
          <div class="row">
            <div class="justify-content-center py-3 mt-2  w-50">
              <div style={{}} class="col-md-8 p-2 ">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Type of Plan :</label>
                  <select
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row border">
                  <label class="fw-bolder w-50 mt-2">Vehicle Class :</label>
                  <select
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Tenure in Months:</label>
                  <select
                    class="form-control w-50"
                    id="Dependents"
                    name="Dependents"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Contract:</label>
                  <select
                    class="form-control w-50"
                    id="PaperlessBilling"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Transaction Type :</label>
                  <select
                    class="form-control w-50"
                    id="PhoneService"
                    name="PhoneService"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Rechability:</label>
                  <select
                    class="form-control w-50"
                    id="MultipleLines"
                    name="MultipleLines"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Gender:</label>
                  <select
                    class="form-control w-50"
                    id="gender"
                    name="gender"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">SeniorCitizen:</label>
                  <select
                    class="form-control w-50"
                    id="InternetService"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row ">
                  <label class="fw-bolder w-50 mt-2">Payment:</label>
                  <select
                    class="form-control w-50"
                    id="PaymentMethod"
                    name="PaymentMethod"
            ...
            <div class="justify-content-center py-3 w-50">
              <div class="col-md-8 p-2 ">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2"> Branch:</label>
                  <select
                    class="form-control w-50"
                    id="OnlineSecurity"
                    name="OnlineSecurity"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Province :</label>
                  <select
                    class="form-control w-50"
                    id="OnlineBackup"
                    name="OnlineBackup"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">District :</label>
                  <select
                    class="form-control w-50"
                    id="DeviceProtection"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Dependants:</label>
                  <select
                    class="form-control w-50"
                    id="TechSupport"
                    name="TechSupport"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Work Status:</label>
                  <select
                    class="form-control w-50"
                    id="StreamingTV"
                    name="StreamingTV"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Marital Status:</label>
                  <select
                    class="form-control w-50"
                    id="StreamingMovies"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Monthly Charges:</label>
                  <input
                    type="number"
                    min="0"
                    class="form-control w-50"
              ...
              <div class="col-md-8 p-2">
                <div class="form-group row">
                  <label class="fw-bolder w-50 mt-2">Vehicle Age:</label>
                  <input
                    type="number"
                    min="0"
                    class="form-control w-50"
